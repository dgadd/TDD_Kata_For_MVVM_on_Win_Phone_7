...
namespace CustomerApp.Support.ViewModel
{
    public class CustomerViewModel : ViewModelBase
    {
        ...
        private CustomerSaveCommand _customerSaveCommand;
        ...
        public CustomerSaveCommand CustomerSaveCommand
        {
            get
            {
                if (_customerSaveCommand == null)
                {
                    _customerSaveCommand = new CustomerSaveCommand(_customerRepository, _customer);
                }
                return _customerSaveCommand;
            }
        }
    }
}
